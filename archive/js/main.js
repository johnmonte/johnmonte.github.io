...
document.addEventListener('DOMContentLoaded', function(){
      Typed.new('.typed', {
        strings: ["^500Hello^500", "^500Hola^500", "^500你好^500", "^500ٱلسَّلَامُ عَلَيْكُمْ^500", "^500Bonjour^500",  "^500Hallo^500", "^500Ciao^500", "^500こんにちは^500", "^500안녕하세요^500", "^500Здравствуйте^500", "^500नमस्ते^500", "^500Kumusta^500"],
        typeSpeed: 40,
		loop: true
      });
